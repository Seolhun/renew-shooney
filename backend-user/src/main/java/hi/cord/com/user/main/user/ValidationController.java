package hi.cord.com.user.main.user;

import hi.cord.com.user.common.service.common.CommonService;
import hi.cord.com.user.main.price.service.history.PaidHistoryService;
...
public class ValidationController {
    ...
    @Autowired
    public ValidationController(UserService userService, PaidHistoryService paidHistoryService, UserProfileService userProfileService, CommonService commonService) {
