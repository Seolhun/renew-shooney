package hi.cord.com.user.dynamo.controller.nlp;
...
public class NlpRestController {
    private static final Logger LOG = LoggerFactory.getLogger(hi.cord.com.user.mongo.controller.news.NewsDataRestController.class);
