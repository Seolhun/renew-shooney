package hi.cord.com.user.main.user.servie;

import hi.cord.com.user.common.repository.AbstractRepository;
import hi.cord.com.user.main.user.domain.PersistentLogin;
